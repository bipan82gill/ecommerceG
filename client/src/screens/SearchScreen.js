...
export default function SearchScreen(props) {
    ...
    },[dispatch, name, category,  rating, order, pageNumber]);
    ...
    const getFilterUrl = (filter) =>{
        ...
        return `/search/category/${filterCategory}/name/${filterName}/rating/${filterRating}/order/${sortOrder}/pageNumber/${filterPage}`;
    }
    return (
        <div>
            <div className="row">
            ...
            <div>
                ...
                >
                    ...
                    <option value="lowest">Prices: Low to High</option>
                    <option value="highest">Prices: High to Low </option>
